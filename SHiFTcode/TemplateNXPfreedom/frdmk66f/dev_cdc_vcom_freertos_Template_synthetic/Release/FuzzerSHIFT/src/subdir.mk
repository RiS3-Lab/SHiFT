...
FuzzerSHIFT/src/%.o: ../FuzzerSHIFT/src/%.c FuzzerSHIFT/src/subdir.mk
	@echo 'Building file: $<'
...
clean-FuzzerSHIFT-2f-src:
	-$(RM) ./FuzzerSHIFT/src/MonitorAndTargetSingleCore.d ./FuzzerSHIFT/src/MonitorAndTargetSingleCore.o
